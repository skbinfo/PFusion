...
def bedprint(g1a,g1b,g1c,g1d,g2a,g2b,g2c,g2d):
    ...
    if 'bedstr1' in locals() and 'bedstr2' in locals():
    ...
    genome="/home/malini/pragya/cicer_pride/leaf_PXD005578/database_files/GCF_000331145.1_ASM33114v1_genomic.fna"
    ...
    transeq="/home/malini/software/EMBOSS-6.6.0/emboss/transeq"
    ...
    darg = ['/home/malini/software/EMBOSS-6.6.0/emboss/pepdigest', '-seqall', srr_id+"_pep.fa", '-outfile', srr_id+".pepdigest", '-menu', '1', '-mono', 'no']
    try:
        er=open("error",'w')
        ...
        with open(ericf,'r') as f:
            ...
            for x in lines:
                ...
                try:
                    ...
                    pass
                if isinstance(phla, int) and isinstance(dusra, int):
                    gene1=x.split('\t')[8]
                    chr_gene1=x.split("\t")[2]
                    bp_gene1=x.split("\t")[3]
