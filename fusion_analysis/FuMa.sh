...
GENE_ANNOTATION="/home/nipgr/Documents/chickpea/genome_files/fuma_gtf.bed"
...
MAPSPLICE_IN=$1/MapSplice_out/fusions_candidates.txt
MAPSPLICE_OUT=$1/MapSplice_out/fusions_candidates_uuqZ1Q.txt
STAR_IN=$1/STARFusion-out/star-fusion.fusion_predictions.tsv
TRINITY_IN=$1/TrinityFusion_out/TrinityFusion-UC.fusion_predictions.tsv
FUSION_BLOOM_IN=$1/$1\_FusionBloomOut/pavfinder/sv.bedpe
FUSION_BLOOM_OUT=$1/$1\_FusionBloomOut/pavfinder/sv_uuqZ1Q.bedpe
FUMA_IN=""
LABEL=""
...
LABEL+=" MapSplice:GCF_000331145.1"
else
...
LABEL+=" STAR-Fusion:GCF_000331145.1"
else
...
LABEL+=" Fusion-Bloom:GCF_000331145.1"
else
...
#exact gene match
fuma \
    -a GCF_000331145.1:${GENE_ANNOTATION} \
    -m egm \
